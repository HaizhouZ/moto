...
void register_submodule_ns_sqp(nb::module_ &m) {
    ...
    sqp.def(nb::init<>())
        ...
        .def("create_node", &ns_sqp::create_node, nb::arg("formulation"), nb::rv_policy::reference_internal,
    ...
    nb::class_<graph_type>(sqp, "graph_type")
        .def(nb::init<>())
        .def("add", &graph_type::add, nb::arg("node"), "Add a node to the graph and return a reference to it", nb::rv_policy::reference_internal)
        .def("set_head", &graph_type::set_head, nb::arg("node"), nb::rv_policy::reference_internal)
        .def("set_tail", &graph_type::set_tail, nb::arg("node"), nb::rv_policy::reference_internal)
        ...
        .def_prop_ro("nodes", &graph_type::nodes, nb::rv_policy::reference_internal);
}