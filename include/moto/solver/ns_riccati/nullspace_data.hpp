...
struct nullspace_data {
    // jacobian
    matrix_rm &s_y; ///< state constraint derivative w.r.t. y
    // nullspace
    ...
    matrix_rm s_c_stacked; ///< \f$[s_u;c_u]\f$
    ...
    matrix_rm s_c_stacked_0_K;           ///< \f$[s_x;c_x]\f$
    ...
    nullspace_data(matrix_rm &_s_y) : s_y(_s_y) {}
};
} // namespace ns_riccati
} // namespace solver
} // namespace moto
